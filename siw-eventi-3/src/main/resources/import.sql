...
insert into servizio (id, nome, descrizione, prezzo, image, video) VALUES (nextval('servizio_seq'), 'Vendita di Biglietti ', 'Gestione della vendita dei biglietti per il concerto e promozione dell''evento, inclusi pacchetti VIP con posti privilegiati', 70, 'botteghino.png', 'biglietti.mp4');
...
insert into servizio (id, nome, descrizione, prezzo, image, video) VALUES (nextval('servizio_seq'), 'Degustazione Privata', 'Servizio di degustazione guidata per esplorare i diversi sapori.', 250, 'degustazione.png', 'degustazione.mp4');
